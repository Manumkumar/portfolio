...
const GithubIcon = ({ size = 18, color = '#D4AF37' }) => (
...
const LinkedinIcon = ({ size = 18, color = '#D4AF37' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const TwitterIcon = ({ size = 18, color = '#D4AF37' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ marginTop: '12px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px' }}>
                ...
                >
                  <GithubIcon size={19} color="#D4AF37" />
                  <span>GitHub</span>
                </a>
                ...
                >
                  <LinkedinIcon size={19} color="#D4AF37" />
                  <span>LinkedIn</span>
                </a>
                ...
                >
                  <TwitterIcon size={19} color="#D4AF37" />
                  <span>Twitter / X</span>
                </a>
              </div>
            </div>
